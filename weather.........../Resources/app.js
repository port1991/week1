...
function showInfo(){
	...
	if(json != null){
		...
		var annot = Titanium.Map.createAnnotation({
		    latitude: json.current_observation.display_location.latitude,
		    longitude: json.current_observation.display_location.longitude,
		    title: json.current_observation.display_location.full,
		    subtitle: 'Weather: ' + json.current_observation.weather,
		    //pinImage:'/images/pin.png',
		    //pinImage: json.current_observation.icon_url,
		    animate:true,
		    leftButton: json.current_observation.icon_url
		});
		annoatationData.push(annot);
